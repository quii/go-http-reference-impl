...
// 			},
// 			StoreRecipeFunc: func(recipe models.Recipe) (string, error) {
...
func (mock *RecipeServiceMock) GetRecipe(id string) (models.Recipe, error) {
...
func (mock *RecipeServiceMock) StoreRecipe(recipe models.Recipe) (string, error) {
